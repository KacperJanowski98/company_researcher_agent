...
qwen2_5 = ChatOllama(
    model="qwen2.5:14b", temperature=0, rate_limiter=rate_limiter
)
...
def generate_queries(state: OverallState, config: RunnableConfig) -> dict[str, Any]:
    ...
    structured_llm = qwen2_5.with_structured_output(Queries)
...
async def research_company(
    ...
    result = await qwen2_5.ainvoke(p)
...
def gather_notes_extract_schema(state: OverallState) -> dict[str, Any]:
    ...
    structured_llm = qwen2_5.with_structured_output(state.extraction_schema)
...
def reflection(state: OverallState) -> dict[str, Any]:
    ...
    structured_llm = qwen2_5.with_structured_output(ReflectionOutput)
